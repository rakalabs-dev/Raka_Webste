        ...
        <section className="py-20 bg-black">
            ...
            <div className="max-w-5xl mx-auto px-6">
                ...
                <h1 className="text-4xl md:text-5xl tracking-tight text-center font-heading text-white mb-6 leading-tight">
                    How <span className="font-bold text-blue-500">Rakalabs</span> Transformed EV Charger Operations
                    with a Centralized <span className="font-bold text-blue-500">CRM</span> & Automation Ecosystem
                </h1>
                ...
                <p className="text-lg text-neutral-200 mb-12 leading-relaxed">
                    ...
                    systems and disconnected data sources. Rakalabs designed and implemented a
                ...
                <p className="text-neutral-200 mb-8 leading-relaxed">
                    ...
                    Jumptech, legacy Typeform surveys, and internal databases. As installation volumes increased,
                    operational complexity grew rapidly, affecting response times, data accuracy, and scalability.
                </p>
                ...
                <div className="bg-neutral-900 p-6 rounded-2xl shadow-md mb-8">
                ...
                <p className="text-neutral-200 mb-6">
                    Rakalabs conducted a full system audit identifying three primary data sources:
                </p>

                <ul className="list-disc pl-6 text-neutral-200 space-y-3 mb-8">
                ...
                {/* Improve Phase */}
                <h2 className="text-3xl font-heading font-bold text-blue-500 mb-4">
                    Improve Phase — Rakalabs Solution
                </h2>

                <div className="space-y-8 mb-12">

                    <div>
                        <h3 className="text-xl font-heading text-blue-500 mb-2">
                ...
                {/* Results */}
                <h2 className="text-2xl font-heading font-bold text-blue-500 mb-6">
                    Results & Business Impact
                </h2>

                <div className="bg-neutral-900 p-8 rounded-2xl mb-10">
                ...
                <div className="overflow-x-auto mb-12">
                    <table className="min-w-full bg-neutral-900 border border-neutral-800 rounded-xl">
                        <thead className="bg-neutral-800">
                            <tr>
                                <th className="p-4 text-left text-blue-500">Metric</th>
                                <th className="p-4 text-left text-blue-500">Before Rakalabs</th>
                                <th className="p-4 text-left text-blue-500">After Rakalabs</th>
                            </tr>
                        </thead>
                ...
                <p className="text-neutral-200 leading-relaxed mb-12">
                    ...
                    Rakalabs redesigned the operational data flow using automation-first principles,
                    enabling confident expansion and improved customer experience.
                </p>
