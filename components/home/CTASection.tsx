  ...
  return (
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        {/* Glass/blue-Black Card */}
        <div className="relative bg-black/60 backdrop-blur-md border border-blue-500 shadow-lg rounded-2xl p-10 md:p-14">

          <h2 className="font-heading tracking-tight leading-tight text-3xl md:text-4xl text-blue-500 mb-6">
