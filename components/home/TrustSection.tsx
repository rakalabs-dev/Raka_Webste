...
const TrustSection = () => {
  ...
  return (
    <section className=" relative py-16 md:py-20 ">
      <div className="max-w-8xl mx-2 lg:mx-4 py-6 sm:py-8 lg:py-10 px-4 sm:px-6 lg:px-8 border border-blue-200 rounded-lg bg-gray-900/60">

        {/* Heading */}
        <div className="text-center mb-12">
          <h2 className="font-heading tracking-tight text-4xl text-white font-bold mb-4">
            Trusted by Growing <span className="text-blue-500">
              Businesses
            </span>
          </h2>
          <p className="text-neutral-200 text-lg">
            Join companies that transformed operations with Raka.
          </p>
        </div>
          ...
          {testimonials.map((item, index) => (
            <div
              ...
              className="
                ...
                bg-gray-800/70 border border-blue-500 backdrop-blur-lg
                p-6 rounded-2xl shadow-lg shadow-blue-500/50
                transition-transform hover:scale-105 cursor-pointer
              "
            >
              <h3 className="font-heading text-xl font-semibold text-blue-500 mb-2">
                {item.company}
              </h3>
