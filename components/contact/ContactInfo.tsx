  ...
  return (
    <div>
      ...
      <div className="space-y-6 mb-12">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-neutral-200">rakalabs12@gmail.com</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-neutral-200">Monday - Saturday: 24/7</p>
      ...
      <div className="bg-gradient-to-br from-blue-50 to-red-50 p-8 rounded-lg">
        <h3 className="font-heading font-bold tracking-tight leading-tight text-xl text-blue-800 mb-4">
        ...
        <Link href="https://calendly.com/rakalabs12/30min" target="_blank">
          <button className="w-full bg-blue-700 text-white px-6 py-3 rounded-lg hover:bg-blue-800 cursor-pointer transition shadow-custom font-medium">
            Schedule Now
          </button>
        </Link>
      </div>
